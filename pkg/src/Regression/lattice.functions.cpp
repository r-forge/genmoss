...
void RandomModel(int* amodel,int lenmodel,int** VarSets,int* lenVarSets,double prob, gsl_rng * stream)
{
	int i;
	int r[lenmodel];
	
	//viRngBernoulli(METHOD, stream, lenmodel, r, prob);
	// Since GSL allows to draw only one num, insert code into forloop below.
