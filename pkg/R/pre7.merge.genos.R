pre7.merge.genos <- function(dir.file, dir.dat=dir.file, dir.out=dir.file, file.out="CGEM_Breast_complete.txt", dat.out="CGEM_Breast_complete.dat", prefix.file, prefix.dat, key.file="", key.dat="", ending.file=".txt", ending.dat=".dat", num.nonsnp.col=0, num.nonsnp.last.col=1, weak.check=FALSE, plan=FALSE) {
...
info.genos <- extract.chrom.dir(dir.file=dir.file, prefix=prefix.file, key=key.file, endin=ending.file)
