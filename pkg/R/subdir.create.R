...
# out$s5 - subdirectory into which genos will be converted to binary values.
...
d5  <- paste(dir.main, "/working/", prefix.dir, "05_discrete", sep="")
...
return(list(s0=dir.main, s1=d1, s2=d2, s3=d3, s4=d4, s5=d5))
